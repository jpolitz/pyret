({
  ...
  provides: {
    ...
    values: {
      ...
      // Monomorphic numeric operators (flat: never dispatch, never suspend). Emitted
      // by the typed-operator-weakening pass when both operands are proven Number.
      "_plus_nums": {'bind': 'fun',
                  'flatness': 0,
                  'name': '_plus_nums',
                  'typ': ['arrow', ['Number', 'Number'], 'Number']},
      "_minus_nums": {'bind': 'fun',
                  'flatness': 0,
                  'name': '_minus_nums',
                  'typ': ['arrow', ['Number', 'Number'], 'Number']},
      "_times_nums": {'bind': 'fun',
                  'flatness': 0,
                  'name': '_times_nums',
                  'typ': ['arrow', ['Number', 'Number'], 'Number']},
      "_divide_nums": {'bind': 'fun',
                  'flatness': 0,
                  'name': '_divide_nums',
                  'typ': ['arrow', ['Number', 'Number'], 'Number']},
      "_lessthan_nums": {'bind': 'fun',
                  'flatness': 0,
                  'name': '_lessthan_nums',
                  'typ': ['arrow', ['Number', 'Number'], 'Boolean']},
      "_lessequal_nums": {'bind': 'fun',
                  'flatness': 0,
                  'name': '_lessequal_nums',
                  'typ': ['arrow', ['Number', 'Number'], 'Boolean']},
      "_greaterthan_nums": {'bind': 'fun',
                  'flatness': 0,
                  'name': '_greaterthan_nums',
                  'typ': ['arrow', ['Number', 'Number'], 'Boolean']},
      "_greaterequal_nums": {'bind': 'fun',
                  'flatness': 0,
      ...
      "_plus_strings": {'bind': 'fun', 'flatness': 0, 'name': '_plus_strings',
                  'typ': ['arrow', ['String', 'String'], 'String']},
      "_lessthan_strings": {'bind': 'fun', 'flatness': 0, 'name': '_lessthan_strings',
                  'typ': ['arrow', ['String', 'String'], 'Boolean']},
      "_greaterthan_strings": {'bind': 'fun', 'flatness': 0, 'name': '_greaterthan_strings',
                  'typ': ['arrow', ['String', 'String'], 'Boolean']},
      "_lessequal_strings": {'bind': 'fun', 'flatness': 0, 'name': '_lessequal_strings',
                  'typ': ['arrow', ['String', 'String'], 'Boolean']},
      "_greaterequal_strings": {'bind': 'fun', 'flatness': 0, 'name': '_greaterequal_strings',
                  'typ': ['arrow', ['String', 'String'], 'Boolean']},
      "tostring_num": {'bind': 'fun', 'flatness': 0, 'name': 'tostring_num',
                  'typ': ['arrow', ['Number'], 'String']},
      "torepr_num": {'bind': 'fun', 'flatness': 0, 'name': 'torepr_num',
                  'typ': ['arrow', ['Number'], 'String']},
      "tostring_str": {'bind': 'fun', 'flatness': 0, 'name': 'tostring_str',
                  'typ': ['arrow', ['String'], 'String']},
      "torepr_str": {'bind': 'fun', 'flatness': 0, 'name': 'torepr_str',
                  'typ': ['arrow', ['String'], 'String']},
      "tostring_bool": {'bind': 'fun', 'flatness': 0, 'name': 'tostring_bool',
                  'typ': ['arrow', ['Boolean'], 'String']},
      "torepr_bool": {'bind': 'fun', 'flatness': 0, 'name': 'torepr_bool',
                  'typ': ['arrow', ['Boolean'], 'String']},
      // raise, exposed flat (it is a synchronous throw -- never dispatches/suspends).
      "raise_flat": {'bind': 'fun', 'flatness': 0, 'name': 'raise_flat',
                  'typ': ['arrow', ['Any'], 'tbot']},
