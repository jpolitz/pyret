...
◊ebnf['Pyret]{
◊nd{import-stmt}: ◊tk{IMPORT} ◊nt{import-source} ◊tk{AS} ◊tmi{NAME}
...
◊nd{import-special}: ◊tmi{NAME} ◊tk{PARENNOSPACE} ◊tmi{STRING} (◊tk{COMMA} ◊tmi{STRING})* ◊tk{RPAREN}
...
◊ebnf['Pyret]{
◊nd{provide-stmt}: ◊tk{PROVIDE} ◊nt{stmt} ◊tk{END} | ◊tk{PROVIDE} ◊tk{STAR}
}

◊ebnf['Pyret]{
◊nd{provide-types-stmt}: ◊tk{PROVIDE-TYPES} ◊nt{record-ann} | ◊tk{PROVIDE-TYPES} ◊tk{STAR}
}
...
◊nd{name-binding}: [◊tk{SHADOW}] ◊tmi{name} [◊tk{COLONCOLON} ◊nt{ann}]
◊nd{tuple-binding}: ◊tk{LBRACE} (◊nt{binding} ◊tk{SEMI})* ◊nt{binding} [◊tk{SEMI}] ◊tk{RBRACE} [◊tk{AS} ◊nt{name-binding}]
}
...
◊ebnf['Pyret]{
◊nd{block}: ◊nt{stmt}*
◊nd{user-block-expr}: ◊tk{BLOCKCOLON} ◊nt{block} ◊tk{END}
}
...
◊ebnf['Pyret]{
◊nd{let-decl}: ◊nt{binding} ◊tk{EQUALS} ◊nt{binop-expr}
}
...
◊ebnf['Pyret]{
◊nd{rec-decl}: ◊tk{REC} ◊nt{binding} ◊tk{EQUALS} ◊nt{binop-expr}
}
...
◊ebnf['Pyret]{
◊nd{fun-decl}: ◊tk{FUN} ◊tmi{NAME} ◊nt{fun-header} [◊tk{BLOCK}] ◊tk{COLON} ◊nt{doc-string} ◊nt{block} ◊nt{where-clause} ◊tk{END}
◊nd{fun-header}: ◊nt{ty-params} ◊nt{args} ◊nt{return-ann}
◊nd{ty-params}: [◊tk{LANGLE} ◊nt{list-ty-param}* ◊tmi{NAME} ◊tk{RANGLE}]
◊nd{list-ty-param}: ◊tmi{NAME} ◊tk{COMMA}
◊nd{args}: ◊tk{LPAREN} [◊nt{list-arg-elt}* ◊nt{binding}] ◊tk{RPAREN}
◊nd{list-arg-elt}: ◊nt{binding} ◊tk{COMMA}
◊nd{return-ann}: [◊tk{THINARROW} ◊nt{ann}]
◊nd{doc-string}: [◊tk{DOC} ◊tmi{STRING}]
◊nd{where-clause}: [◊tk{WHERE} ◊nt{block}]
}
...
◊ebnf['Pyret]{
◊nd{data-decl}: ◊tk{DATA} ◊tmi{NAME} ◊nt{ty-params} ◊tk{COLON}
    ◊nt{data-variant}*
    ◊nt{data-sharing}
    ◊nt{where-clause}
  ◊tk{END}
◊nd{data-variant}: ◊tk{PIPE} ◊tmi{NAME} ◊nt{variant-members} ◊nt{data-with} | ◊tk{PIPE} ◊tmi{NAME} ◊nt{data-with}
◊nd{variant-members}: ◊tk{LPAREN} [◊nt{list-variant-member}* ◊nt{variant-member}] ◊tk{RPAREN}
◊nd{list-variant-member}: ◊nt{variant-member} ◊tk{COMMA}
◊nd{variant-member}: [◊tk{REF}] ◊nt{binding}
◊nd{data-with}: [◊tk{WITH} ◊nt{fields}]
◊nd{data-sharing}: [◊tk{SHARING} ◊nt{fields}]
}
...
◊ebnf['Pyret]{
◊nd{var-decl}: ◊tk{VAR} ◊nt{binding} ◊tk{EQUALS} ◊nt{expr}
}
...
◊ebnf['Pyret]{
◊nd{type-stmt}: ◊tk{TYPE} ◊nt{type-decl}
◊nd{type-decl}: ◊tmi{NAME} ◊nt{ty-params} ◊tk{EQUALS} ◊nt{ann}
}
...
◊nd{newtype-decl}: ◊tk{NEWTYPE} ◊tmi{NAME} ◊tk{AS} ◊tmi{NAME}
}
When we write
◊examples{
...
◊ebnf['Pyret]{
◊nd{contract}: ◊tmi{NAME} ◊tk{COLONCOLON} ◊nt{ty-params} ◊nt{ann} | ◊tmi{NAME} ◊tk{COLONCOLON} ◊nt{ty-params} ◊nt{contract-arrow-ann}
◊nd{contract-arrow-ann}: (◊nt{ann} ◊tk{COMMA})* ◊nt{ann} ◊tk{THINARROW} ◊nt{ann} 
...
◊ebnf['Pyret]{
◊nd{when-stmt}: ◊tk{WHEN} ◊nt{binop-expr} [◊tk{BLOCK}] ◊tk{COLON} ◊nt{block} ◊tk{END}
}
...
◊ebnf['Pyret]{
◊nd{assign-stmt}: ◊tmi{NAME} ◊tk{COLON-EQUALS} ◊nt{binop-expr}
}
...
◊nd{expr}: ◊nt{paren-expr} | ◊nt{id-expr} | ◊nt{prim-expr}
    ...
    | ◊nt{template-expr}
    | ◊nt{get-bang-expr} | ◊nt{update-expr}
    | ◊nt{if-expr} | ◊nt{ask-expr} | ◊nt{cases-expr}
    | ◊nt{for-expr}
    | ◊nt{user-block-expr} | ◊nt{inst-expr}
    | ◊nt{construct-expr}
    | ◊nt{multi-let-expr} | ◊nt{letrec-expr}
    | ◊nt{type-let-expr}
    | ◊nt{construct-expr}
    | ◊nt{table-expr}
    | ◊nt{table-select}
    ...
    | ◊nt{load-table-expr}
    | ◊nt{reactor-expr}
◊nd{paren-expr}: ◊tk{LPAREN} ◊nt{binop-expr} ◊tk{RPAREN}
◊nd{id-expr}: ◊tmi{NAME}
...
◊ebnf['Pyret]{
◊nd{lam-expr}: ◊tk{LAM} ◊nt{fun-header} [◊tk{BLOCK}] ◊tk{COLON}
    ◊nt{doc-string}
    ◊nt{block}
    ◊nt{where-clause}
  ◊tk{END}
...
◊ebnf['Pyret]{
◊nd{curly-lam-expr}: ◊tk{LBRACE} ◊nt{fun-header} [◊tk{BLOCK}] ◊tk{COLON}
    ◊nt{doc-string}
    ◊nt{block}
    ◊nt{where-clause}
  ◊tk{RBRACE}
...
◊ebnf['Pyret]{
◊nd{method-expr}: ◊tk{METHOD} ◊nt{fun-header} [◊tk{BLOCK}] ◊tk{COLON} ◊nt{doc-string} ◊nt{block} ◊nt{where-clause} ◊tk{END}
}
...
◊nd{app-args}: ◊tk{LPAREN} [◊nt{app-arg-elt}* ◊nt{binop-expr}] ◊tk{RPAREN}
◊nd{app-arg-elt}: ◊nt{binop-expr} ◊tk{COMMA}
}
...
◊ebnf['Pyret]{
◊nd{chain-app-expr}: ◊nt{binop-expr} ◊tk{CARET} ◊nt{binop-expr}
}
...
◊ebnf['Pyret]{
◊nd{inst-expr}: ◊nt{expr} ◊tk{LANGLE} ◊nt{ann} (◊tk{COMMA} ◊nt{ann})* ◊tk{RANGLE}
}
...
◊ebnf['Pyret]{
◊nd{tuple-expr}: ◊tk{LBRACE} ◊nt{tuple-fields} ◊tk{RBRACE}
◊nd{tuple-fields}: ◊nt{binop-expr} (◊tk{SEMI} ◊nt{binop-expr})* [◊tk{SEMI}]
}
...
◊ebnf['Pyret]{
◊nd{tuple-get}: ◊nt{expr} ◊tk{DOT} ◊tk{LBRACE} ◊tmi{NUMBER} ◊tk{RBRACE}
}
...
◊ebnf['Pyret]{
◊nd{obj-expr}: ◊tk{LBRACE} ◊nt{fields} ◊tk{RBRACE} | ◊tk{LBRACE} ◊tk{RBRACE}
◊nd{fields}: ◊nt{list-field}* ◊nt{field} [◊tk{COMMA}]
◊nd{list-field}: ◊nt{field} ◊tk{COMMA}
◊nd{field}: ◊nt{key} ◊tk{COLON} ◊nt{binop-expr}
...
◊ebnf['Pyret]{
◊nd{dot-expr}: ◊nt{expr} ◊tk{DOT} ◊tmi{NAME}
}
...
◊ebnf['Pyret]{
◊nd{extend-expr}: ◊nt{expr} ◊tk{DOT} ◊tk{LBRACE} ◊nt{fields} ◊tk{RBRACE}
}
...
◊ebnf['Pyret]{
◊nd{if-expr}: ◊tk{IF} ◊nt{binop-expr} [◊tk{BLOCK}] ◊tk{COLON} ◊nt{block} ◊nt{else-if}* [◊tk{ELSECOLON} ◊nt{block}] ◊tk{END}
◊nd{else-if}: ◊tk{ELSEIF} ◊nt{binop-expr} ◊tk{COLON} ◊nt{block}
}
...
◊ebnf['Pyret]{
◊nd{ask-expr}: ◊tk{ASK} [◊tk{BLOCK}] ◊tk{COLON} ◊nt{ask-branch}* [◊tk{BAR} ◊tk{OTHERWISECOLON} ◊nt{block}] ◊tk{END}
◊nd{ask-branch}: ◊tk{BAR} ◊nt{binop-expr} ◊tk{THENCOLON} ◊nt{block}
}
...
◊ebnf['Pyret]{
◊nd{cases-expr}: ◊tk{CASES} ◊tk{LPAREN} ◊nt{ann} ◊tk{RPAREN} ◊nt{expr} [◊tk{BLOCK}] ◊tk{COLON}
    ◊nt{cases-branch}*
    [◊tk{BAR} ◊tk{ELSE} ◊tk{THICKARROW} ◊nt{block}]
  ◊tk{END}
◊nd{cases-branch}: ◊tk{BAR} ◊tmi{NAME} [◊nt{args}] ◊tk{THICKARROW} ◊nt{block}
}
...
◊ebnf['Pyret]{
◊nd{for-expr}: ◊tk{FOR} ◊nt{expr} ◊tk{PARENNOSPACE} [◊nt{for-bind-elt}* ◊nt{for-bind}] ◊tk{RPAREN} ◊nt{return-ann} [◊tk{BLOCK}] ◊tk{COLON}
  ◊nt{block}
◊tk{END}
◊nd{for-bind-elt}: ◊nt{for-bind} ◊tk{COMMA}
◊nd{for-bind}: ◊nt{binding} ◊tk{FROM} ◊nt{binop-expr}
}
...
◊ebnf['Pyret]{
◊nd{table-expr}: ◊tk{TABLE} ◊nt{table-headers} ◊nt{table-rows} ◊tk{END}
◊nd{table-headers}: [◊nt{table-header} ◊tk{COMMA}]* ◊nt{table-header}
◊nd{table-header}: ◊tmi{NAME} [◊tk{COLONCOLON} ◊nt{ann}]
◊nd{table-rows}: ◊nt{table-row}* ◊nt{table-row}
◊nd{table-row}: ◊tk{ROW} [◊nt{binop-expr} ◊tk{COMMA}]* ◊nt{binop-expr}
}

◊ebnf['Pyret]{
◊nd{table-select}: ◊tk{TABLE-SELECT} ◊tmi{NAME} (◊tk{COMMA} ◊tmi{NAME})* ◊tk{FROM} ◊nt{expr} ◊tk{END}
}

◊ebnf['Pyret]{
◊nd{table-sieve}: ◊tk{TABLE-FILTER} ◊nt{expr} [◊tk{USING} ◊nt{binding} (◊tk{COMMA} ◊nt{binding})*] ◊tk{COLON} ◊nt{binop-expr} ◊tk{END}
}


◊subsubsection[#:tag "s:tables:order"]{Sorting Table Rows}
◊ebnf['Pyret]{
◊nd{table-order}: ◊tk{TABLE-ORDER} ◊nt{expr} ◊tk{COLON} ◊nt{column-order} ◊tk{END}
◊nd{column-order}: ◊tmi{NAME} ◊tk{ASCENDING} | ◊tmi{NAME} ◊tk{DESCENDING}
}

◊subsubsection[#:tag "s:tables:transform"]{Transforming Table Rows}
◊ebnf['Pyret]{
◊nd{table-transform}: ◊tk{TABLE-TRANSFORM} ◊nt{expr} [◊tk{USING} ◊nt{binding} (◊tk{COMMA} ◊nt{binding})*] ◊tk{COLON} ◊nt{transform-fields} ◊tk{END}
◊nd{transform-fields}: ◊nt{transform-field} (◊tk{COMMA} ◊nt{transform-field})* [◊tk{COMMA}]
◊nd{transform-field}: ◊nt{key} ◊tk{COLON} ◊nt{binop-expr}
}

◊subsubsection[#:tag "s:tables:extract"]{Extracting Table Columns}
◊ebnf['Pyret]{
◊nd{table-extract}: ◊tk{TABLE-EXTRACT} ◊tmi{NAME} ◊tk{FROM} ◊nt{expr} ◊tk{END}
}

◊subsubsection[#:tag "s:tables:extend"]{Adding Table Columns}
◊ebnf['Pyret]{
◊nd{table-extend}: ◊tk{TABLE-EXTEND} ◊nt{expr} [◊tk{USING} ◊nt{binding} (◊tk{COMMA} ◊nt{binding})*] ◊tk{COLON} [◊nt{table-extend-field} ◊tk{COMMA}]* ◊nt{table-extend-field} ◊tk{END}
◊nd{table-extend-field}: ◊nt{key} [◊tk{COLONCOLON} ◊nt{ann}] ◊tk{COLON} ◊nt{binop-expr}
...
◊ebnf['Pyret]{
◊nd{load-table-expr}: ◊tk{LOAD-TABLE} ◊tk{COLON} ◊nt{table-headers} [◊nt{load-table-specs}] ◊tk{END}
◊nd{load-table-specs}: ◊nt{load-table-spec}* ◊nt{load-table-spec}
◊nd{load-table-spec}: ◊tk{SOURCECOLON} ◊nt{expr}
...
◊ebnf['Pyret]{
◊nd{reactor-expr}: ◊tk{REACTOR} ◊tk{COLON}
...
◊ebnf['Pyret]{
◊nd{get-bang-expr}: ◊nt{expr} ◊tk{BANG} ◊tmi{NAME}
◊nd{update-expr}: ◊nt{expr} ◊tk{BANG} ◊tk{LBRACE} ◊nt{fields} ◊tk{RBRACE}
}
...
◊ebnf['Pyret]{
◊nd{construct-expr}: ◊tk{LBRACK} ◊nt{binop-expr} ◊tk{COLON} ◊nt{construct-args} ◊tk{RBRACK}
◊nd{construct-args}: [◊nt{binop-expr} (◊tk{COMMA} ◊nt{binop-expr})*]
}
...
◊ebnf['Pyret]{
◊nd{multi-let-expr}: ◊tk{LET} ◊nt{let-or-var} (◊tk{COMMA} ◊nt{let-or-var})* [◊tk{BLOCK}] ◊tk{COLON} ◊nt{block} ◊tk{END}
◊nd{let-or-var}: ◊nt{let-decl} | ◊nt{var-decl}
◊nd{letrec-expr}: ◊tk{LETREC} ◊nt{let-decl} (◊tk{COMMA} ◊nt{let-decl})* [◊tk{BLOCK}] ◊tk{COLON} ◊nt{block} ◊tk{END}
◊nd{type-let-expr}: ◊tk{TYPE-LET} ◊nt{type-let-or-newtype} (◊tk{COMMA} ◊nt{type-let-or-newtype})* [◊tk{BLOCK}] ◊tk{COLON} ◊tk{END}
...
◊nd{dot-ann}: ◊tmi{NAME} ◊tk{DOT} ◊tmi{NAME}
          }
...
◊pyret-block{
import equality as EQ
eq-result :: EQ.EqualityResult = equal-always3(5, 6)
}

◊subsection[#:tag "s:app-ann"]{Parametric Annotations}
◊ebnf['Pyret]{
◊nd{app-ann}: ◊nt{name-ann}  ◊tk{LANGLE} ◊nt{comma-anns} ◊tk{RANGLE} | dot-ann ◊tk{LANGLE} ◊nt{comma-anns} ◊tk{RANGLE}
◊nd{comma-anns}: ◊nt{ann} (◊tk{COMMA} ◊nt{ann})*
}
...
◊ebnf['Pyret]{
◊nd{arrow-ann}: ◊tk{LPAREN} (◊nt{ann} ◊tk{COMMA})* ◊nt{ann} ◊tk{THINARROW} ◊nt{ann} ◊tk{RPAREN}
...
◊ebnf['Pyret]{
◊nd{pred-ann}: ◊nt{ann} ◊tk{PERCENT} ◊tk{LPAREN} ◊tmi{NAME} ◊tk{RPAREN}
          }
...
◊ebnf['Pyret]{
◊nd{tuple-ann}: ◊tk{LBRACE} ◊nt{ann} (◊tk{SEMI} ◊nt{ann})* [◊tk{SEMI}] ◊tk{RBRACE}
}
...
◊ebnf['Pyret]{
◊nd{record-ann}: ◊tk{LBRACE} ◊nt{ann-field} (◊tk{COMMA} ◊nt{ann-field})* ◊tk{RBRACE}
◊nd{ann-field}: ◊tmi{NAME} ◊tk{COLONCOLON} ◊nt{ann}
}
